...
gh_recon/
  ...
  api/            # requests-based GitHub client, split by domain
    ...
    actions.py    #   Actions usage metrics + self-hosted runners + current-job correlation
